...
import phone from '../image/bx_bx-phone-call.svg'
import email from '../image/bx_bxl-whatsapp.svg'
import location from '../image/cil_location-pin.svg'
import Modal from './Modal'

const Footer = ()=> {
    return(        
        <footer className="py-4 sm:p-6 shadow-lg bg-gray-100 dark:bg-gray-900">
            <div className="container flex flex-col items-center justify-between p-10 md:flex-row md:space-y-0">
                <div className="pl-5">
                    <div className='bg-center'>
                        <a href="/">
                            <img src={logo} alt='Champi Logo' className='bg-center'></img>
                        </a>
                    </div>
                ...
                <div className='container max-w-lg mx-auto items-center justify-between pl-36'>
                    <h2 className="mb-6 text-sm font-semibold text-center justify-start text-gray-900 uppercase dark:text-white md:text-left">Links</h2>
                    <ul className="text-gray-600 text-left dark:text-gray-400">
                        <li className="mb-1">
                            <a href="#" className="hover:underline">Our Project</a>
                        </li>
                        <li className="mb-1">
                ...
                <div>
                    ...
                    <div className='pr-5'>
                        <div className='flex flex-row pb-4'>
                            <img src={email} alt='Phone Number'></img>
                            <h1 className='pl-4'>555 341 0032</h1>
                        </div>
                        <div className='flex flex-row pb-4'>
                            <img src={phone} alt='Email Company'></img>
                            <h1 className='pl-4'>info@abcfood.com</h1>
                        </div>
                        <div className='flex flex-row'>
                            <img src={location} alt='Location Company'></img>
                            <h1 className='pl-4'>Menara Mandiri, Tower II, 20-21st Floor, Jl. Jend. Sudirman No.Kav. 54-55, RT.5/RW.3</h1>
                        </div>
                    </div>
                </div>
            </div>
            <div className=" bg-blue-900 py-2 sm:flex sm:items-center sm:justify-between">
                <span className="pl-4 text-sm text-white sm:text-center dark:text-gray-400">© 2023. All Rights Reserved.
                </span>
                <div className="flex mt-4 pr-4 space-x-6 sm:justify-center sm:mt-0">
